...
pub struct SearchThoughtsArgs {
    ...
    #[schemars(
        description = "Number of post-RRF candidates fed into the reranker. Ignored when rerank is off. Defaults to 10."
    )]
